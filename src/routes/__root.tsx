...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Field Attendance | Pest Control GPS Tracking" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Field Attendance | Pest Control GPS Tracking" },
      {
        ...
        content: "GPS attendance and site visit tracking for field service teams.",
      },
    ...
    scripts: [
      {
        async: true,
        src: "https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-7079349956820226",
